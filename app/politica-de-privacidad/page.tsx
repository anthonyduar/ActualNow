...
export default async function PrivacidadPage() {
  ...
  // 1. Bloque seguro para traer la página de privacidad
  try {
    ...
    console.warn("Petición de política de privacidad interrumpida o fallida.");
  }
  ...
  try {
    ...
    console.warn("Petición de recomendados en privacidad interrumpida o fallida.");
  }
  ...
  return (
    <main className='max-w-5xl mx-auto px-6 pt-10 text-zinc-300 font-sans min-h-screen bg-black'>
      ...
      {/* CUERPO DEL TEXTO CON CAJA NEGRA, BORDES REDONDEADOS Y BORDE CIAN/AZUL */}
